...
<label>Company</label>&nbsp;
<input type="text" name="Company" style="margin-left:7.5%; background-color:#F5F5F5;  width:25.8%;"/><br/><br/>
<label>Email</label>
<input type="email" name="Email" style="margin-left:11.9%; background-color:#F5F5F5;  width:25.8%;"/><br/><br/>
<label>Phone</label>
<input type="text" name="Phone" style="margin-left:11.5%; background-color:#F5F5F5;  width:25.8%;"/><br/><br/>
<label>Message</label>
