jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"tiles,slice,blocks,elastic,threedflipwithzoom,threedwithzoom,threedtiles,slide,crossfade,threedhorizontalwithzoom,shuffle,threedhorizontal,blinds",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
