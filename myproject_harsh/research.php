...
<div class="sidebar3">
<?php
$select="select * from cms where id='66'";
...
<div class="about-image"><img src="images/research.png"></div>
<div class="about-text"><font color="#716F6F"><?php echo $row['pagedescrp']; ?><f/font></div>
</div>
<div class="rightbar1">
<div class="section-8">
...
<div id="tabs">
  <ul>
  <li><a href="#tabs-1">Weildstrem Research News</a></li>
    <li><a href="#tabs-2">University Centres</a></li>
    <li><a href="#tabs-3">Student Opportunities</a></li>
  </ul>
  <div id="tabs-1">
    <p><font size="2px"><font color="#716F6F">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's<br> standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum has been the industry's standard ...</font></p>
      <div style="margin-top:20px;"><img src="images/pdf 1.png"></div>
     <div style="margin-top:-20px; margin-left:30px; font-size:14px;"><b>Development and Environment</b></div>        
      <div style="margin-top:20px;"><img src="images/pdf 1.png"></div>
     <div style="margin-top:-20px; margin-left:30px; font-size:14px;"><b>Economic potential for reducing carbon dioxide emissions from mangrove loss</b></div>
     <div style="margin-top:20px;"><img src="images/pdf 1.png"></div>
     <div style="margin-top:-20px; margin-left:30px; font-size:14px;"><b>Summary for Policymakers: The True Cost of Electric Power</b></div>
    <div style="margin-top:20px;"><img src="images/pdf 1.png"></div>
     <div style="margin-top:-20px; margin-left:30px; font-size:14px;"><b>The Heterogeneous Effects of Gasoline Taxes: Why Where We Live Matters</b></div> 
     <div style="margin-top:20px;"><img src="images/pdf 1.png"></div>
     <div style="margin-top:-20px; margin-left:30px; font-size:14px;"><b>The Value of Information: Methodological Frontiers and New Applications</b></div>
  </div>
  <div id="tabs-2">
    <p><font size="2px"><font color="#716F6F">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</font><br><br> 
<font size="2px"><font color="#716F6F">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</font></p>
  </div>
  <div id="tabs-3">
    <p><font size="2px"><font color="#716F6F">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</font></p>
  </div>
</div>
</div>
<div class="rightbar7">
<h2><font color="#FFFFFF">&nbsp;&nbsp;Campus News<div style="margin-top:-22px; margin-left:130px;"><img src="images/rss.png" hspace="10"></div></font></h2>
