...
<div class="sidebar1">
<?php
$select="select * from cms where id='61'";
...
<div class="about-image"><img src="images/campus life.png"></div>
...
<?php
$select="select * from cms where id='62'";
$sql=mysqli_query($con,$select) or die("error");
$i=1;
$row=mysqli_fetch_array($sql,MYSQLI_ASSOC);
	?>
<div class="section-16">
<div style="margin-left:30px;"><img src="images/campus1.png"></div>
<div style="margin-left:350px; margin-top:-200px;"><h2><?php echo $row['pagetitle']; ?></h2></div><div class="text-7"><font color="#716F6F"><?php echo $row['pagedescrp']; ?></font><br><br><a href="#"><div style="margin-top:-6px;"><font color="black"><b>Read More +</b></font></div></a>
</div>
<?php
$select="select * from cms where id='63'";
$sql=mysqli_query($con,$select) or die("error");
$i=1;
$row=mysqli_fetch_array($sql,MYSQLI_ASSOC);
	?>
<div class="section-17">
<div style="margin-top:45px; margin-left:30px;"><img src="images/campus2.png"></div>
<div style="margin-left:350px; margin-top:-200px;"><h2><?php echo $row['pagetitle']; ?></h2></div><div class="text-8"><font color="#716F6F"><?php echo $row['pagedescrp']; ?></font><br><br><a href="#"><font color="black"><b>Read More +</b></font></a>
</div>
<?php
$select="select * from cms where id='64'";
$sql=mysqli_query($con,$select) or die("error");
$i=1;
$row=mysqli_fetch_array($sql,MYSQLI_ASSOC);
	?>
<div class="section-18">
<div style="margin-top:65px; margin-left:30px;"><img src="images/campus3.png"></div>
<div style="margin-left:350px; margin-top:-200px;"><h2><?php echo $row['pagetitle']; ?></h2></div><div class="text-8"><font color="#716F6F"><?php echo $row['pagedescrp']; ?></font><br><a href="#"><div style="margin-top:10px;"><font color="black"><b>Read More +</b></font></div></a>
</div>
<div class="rightbar5">
