						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav">
								    ...
								    <li class="active"><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Gallery<span class="caret"></span></a>
										<ul class="dropdown-menu">
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<!-- <a class="example-image-link" href="images/img-3.jpg" data-lightbox="example-set" data-title="">
							 -->	<img src="admin/<?php echo $data['path'] ?>" alt="" />
								<figcaption>
									<h3><b><?php echo $data['imgname']; ?></b></h3>
...
<!-- footer -->
	<div class="footer">
		...
		<div class="w3_agileits_footer_copy">
			<div class="container">
				<p>© 2012 Animals Ngo. All rights reserved | Design by <a href="http://w3layouts.com">Pixel Drop.</a></p>
			</div>
		</div>
	</div>
