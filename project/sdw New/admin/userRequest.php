...
<div class="navbar navbar-inverse">
    ...
    <div class="navbar-collapse collapse navbar-inverse-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="userRequest.php">User Request</a></li>
        ...
        <div class="col-lg-8">
        	<div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center"><b>User-Request</b></h3>
                        </div>
                        <div class="panel-body">
                            <table width="auto" class="table table-striped table-bordered">
                                <tr>
                                 ...
                                 <?php
								$query="select * from swrequest";
								$sql=mysqli_query($con,$query);
									while($result=mysqli_fetch_array($sql))
									{										
										echo "<tr>";
										echo "<td>".$result['RequestID']."</td>";
										echo "<td>".$result['SWName']."</td>";
										echo "<td>".$result['UserName']."</td>";
										echo "<td>".$result['UserEmail']."</td>";
										echo "<td>".$result['SWDate']."</td>";
										echo "</tr>";
									}
								 ?>
                            </table>
