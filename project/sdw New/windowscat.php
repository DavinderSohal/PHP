...
<div class="navbar navbar-inverse">
    ...
    <div class="navbar-collapse collapse navbar-inverse-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="windows.php" class="windows"><span class="fa fa-windows"></span> Windows</a></li>
...
<div class="container">
    <div class="row" style="margin-bottom:10px;">
        ...
        <div class="col-lg-8">
            <h2 class="text-center"><span style="border-bottom:#000 4px solid">Windows <span class="fa fa-windows"></span> &nbsp; Catagories</span></h2>
        </div>
        <div class="col-lg-2"></div>
    </div>
